    ...
    (n = [
      ...
      function (t, e, n) {
        ...
        (e.calculateTTI = function () {
          var e =
            0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : r;
          try {
            (0, u.getLCP)(e, !0),
              (0, u.getFID)(e),
              (0, u.getCLS)(e, !0),
            ...
            (0, a.error)(
              'unable to calculate "web-vitals" performance metrics',
              t
            );
          }
        }),
                  ...
                  (("childList" == (e = e.value).type &&
                    (function t(e, n) {
                      for (var r = (e = l(e)).next(); !r.done; r = e.next())
                        if (
                          ((r = r.value),
                          n.includes(r.nodeName.toLowerCase()) ||
                            t(r.children, n))
                        )
                          return 1;
                    })(e.addedNodes, a)) ||
      ...
      function (t, e, n) {
        ...
        function a(t, e) {
          v ||
            ((v = e), (h = t), (u = new Date()), L(removeEventListener), E());
        }
        function o(t) {
          var e, n, r, i;
          function o() {
          ...
          removeUndefined: function t(e) {
            for (var n in e)
              void 0 === e[n]
                ? delete e[n]
                : "object" === i(e[n]) &&
                  (t(e[n]), 0 === Object.keys(e[n]).length && delete e[n]);
          },
        };
      },
    ]),
